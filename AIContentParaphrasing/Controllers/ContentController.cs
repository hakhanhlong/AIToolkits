...
using AIContentParaphrasing.ViewModels;
using Newtonsoft.Json;

namespace AIContentParaphrasing.Controllers
{
    ...
    public class ContentController : ControllerBase
    {
        ...
        [HttpPost]
        [Route("ContentParaphrasing")]
        public async Task<IActionResult> ContentParaphrasing([FromBody] ContentParaphrasingRequestViewModel request)
        {

            var promptFilePath = Path.Combine(Directory.GetCurrentDirectory(), "Prompts", "ContentParaphrasingVietnam", "skprompt.txt");
            var configFilePath = Path.Combine(Directory.GetCurrentDirectory(), "Prompts", "ContentParaphrasingVietnam", "config.json");
            ...
            {
                ResponseSchema = typeof(ContentParaphrasingResponseViewModel),
            ...
            {
                Data = JsonConvert.DeserializeObject<ContentParaphrasingResponseViewModel>(responseData),
                Info = new
                {
